...
@section('content')
                        ...
                        <div class="card rounded shadow-sm border-0">
                            <div class="card-body p-4">
                                <a href="{{ url('category/' . $prod->slug . '/' . $prod->slug) }}">
                                    <img src="{{ asset('assets/uploads/category/' . $prod->image) }}" alt=""
                                        class="img-fluid d-block mx-auto mb-3">
                                </a>
                                <h5> <a href="{{ url('category/' . $prod->slug . '/' . $prod->slug) }}"
                                        class="text-dark">{{ $prod->name }}</a></h5>
    ...
    <footer class="bg-dark text-white text-center py-3">
        <p>© 2023 TOBA AGRO. Sitorang Punya <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
